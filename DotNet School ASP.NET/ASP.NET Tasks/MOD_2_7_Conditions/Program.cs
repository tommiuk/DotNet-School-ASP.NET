    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            int varNumberB;
            {
                ...
                {
                    Console.WriteLine($"{varNumberA} and {varNumberB} They are equal");
                }
                else
                {
                    Console.WriteLine($"{varNumberA} and {varNumberB} They aren't equal");
                }
            }
